...
namespace EnglishLearning.Infrastructure.Migrations
{
    ...
    [Migration("20260707083952_AddNotificationsAndHangfire")]
    partial class AddNotificationsAndHangfire
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnglishLearning.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EnglishLearning.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 7, 8, 39, 51, 384, DateTimeKind.Utc).AddTicks(3220),
                            Email = "admin@englishlearning.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$DYSMkvopYspZLjJ9CWpCt.9FmI5LzR1buAYb4Bj9X1SF/lchLChay",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 7, 7, 8, 39, 51, 384, DateTimeKind.Utc).AddTicks(3221),
                            Username = "admin"
                        });
                });
